...
{
	public class MusicNameSortData : AccessorBase
	{
		...
		public string startChara { get; private set; }

		public string endChara { get; private set; }
		...
		public void Init(Manager.MaiStudio.Serialize.MusicNameSortData sz)
		{
			name = (StringID)sz.name;
			genreName = sz.genreName;
			genreNameTwoLine = sz.genreNameTwoLine;
			startChara = sz.startChara;
			endChara = sz.endChara;
