...
namespace Monitor.MapResult
{
	public class BonusNumber
	{
		...
		public Image[] digits = new Image[5];

		public BonusNumber(GameObject obj)
		{
			Transform transform = obj.transform;
			digits[4] = transform.GetChild(0).gameObject.GetComponent<Image>();
			digits[3] = transform.GetChild(1).gameObject.GetComponent<Image>();
			digits[2] = transform.GetChild(2).gameObject.GetComponent<Image>();
			digits[1] = transform.GetChild(3).gameObject.GetComponent<Image>();
			digits[0] = transform.GetChild(4).gameObject.GetComponent<Image>();
			string spritePath = _texNumber.GetSpritePath("UI_CMN_Num_70p");
