...
{
	[Serializable]
	public class PlateData : SerializeBase, ISerialize
	{
		...
		public static explicit operator Manager.MaiStudio.PlateData(PlateData sz)
		{
			Manager.MaiStudio.PlateData plateData = new Manager.MaiStudio.PlateData();
			plateData.Init(sz);
			return plateData;
		}
